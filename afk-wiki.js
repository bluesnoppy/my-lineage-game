...
(function () {
  ...
  var MASTERY_FACT = {
    ...
    k_dragonblood: ['耗 HP 技能（含屠宰者）×0.5、治癒藥水 ×1.15，無隱藏數字', '<b>轉換魔法不減半</b>：心靈轉換／魂體轉換／魔力奪取照付原本的 HP，也拿不到龍血 3 件的「龍裔」'],
  ...
  function renderSherine() {
    ...
    out += wCard('🐉 龍血的「消耗HP的技能」不限攻擊技，但轉換魔法不算',
      wDesc('看的是<b>這一招要不要付 HP</b>，跟它是攻擊技還是增益技無關。') +
      wTbl(['技能', '放了會不會拿到「龍裔」'], [
        ['龍騎士的攻擊技（屠宰者／岩漿之箭／奪命之雷／護衛毀滅…）', '<b style="color:#86efac">✓ 會</b>'],
        ['要付 HP 的<b>增益技</b>（覺醒系、血之渴望、龍之護鎧、致命身軀、疼痛的歡愉、冥想術、隱身術、堅固防護…）', '<b style="color:#86efac">✓ 會</b>'],
        ['<b>轉換魔法</b>（心靈轉換／魂體轉換／魔力奪取）', '<b style="color:#f87171">✗ 不會</b>（照扣 HP，但不給龍裔）']
      ]) +
      wDesc('龍血精通的「HP 消耗減半」同樣<b>不含</b>轉換魔法。'));
  ...
  var MAGIC_FACT = {
    ...
    sk_mana_drain: ['命中後吸取 MP＝1~(怪等級÷2)，依異常魔法命中判定；本身不造成傷害', '轉換魔法<b>不算「消耗HP的技能」</b>：拿不到龍血 3 件的「龍裔」，龍血精通的 HP 減半也不適用'],
    ...
    // ===== 妖精專屬(reqE) =====
    sk_elf_mind: ['換回 2 MP；不佔攻擊/治癒冷卻', '轉換魔法<b>不算「消耗HP的技能」</b>：拿不到龍血 3 件的「龍裔」，龍血精通的 HP 減半也不適用'],
    ...
    sk_elf_soul: ['換回 15 MP；不佔攻擊/治癒冷卻', '轉換魔法<b>不算「消耗HP的技能」</b>：拿不到龍血 3 件的「龍裔」，龍血精通的 HP 減半也不適用'],
